...
cd ~/work/src/github.com/yanghaolan/video_server/api
env GOOS=linux GOARCH=amd64 go build -o ../bin/api

cd ~/work/src/github.com/yanghaolan/video_server/scheduler
env GOOS=linux GOARCH=amd64 go build -o ../bin/scheduler

cd ~/work/src/github.com/yanghaolan/video_server/streamserver
